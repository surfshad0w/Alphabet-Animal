...
* **Numbers:** Use the in-app Number Games tab to count, match, and trace numbers 1–10, or open the dedicated [Numbers 1–50 page](numbers.html) to browse all 50 number tiles, hear each number spoken, and see quantities in groups of ten.
